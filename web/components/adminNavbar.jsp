    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <%= currentURL.contains("MovieManaage.jsp") ? "active" : "" %>" aria-current="page" href="MovieManaage.jsp">Movie Manaage</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <%= currentURL.contains("adminBooking.jsp") ? "active" : "" %>" href="adminBooking.jsp">Bookings</a>
                </li>
            </ul>
            <a href="Sign in.jsp" class="btn btn-login">Logout</a>
            <style>
                .btn-login {
